...
; 🔄 Início automático com o Windows — alterna HKCU ou HKLM conforme modo de instalação
Root: {code:GetRunKeyRoot}; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; \
    ValueType: string; ValueName: "AheadNotificador"; \
